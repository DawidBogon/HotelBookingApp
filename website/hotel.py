...
from flask import Blueprint, render_template, request, flash, redirect, url_for, session, make_response, jsonify, current_app
from datetime import datetime
import os
import requests

def construct_blueprint(db, hotel_name):
    hotel = Blueprint(hotel_name, __name__)
    website = db
        ...
        if request.method == 'POST':
            ...
            if reservation_start < reservation_end:
                ...
                for reservation in room_reservations:
                    ...
                    not_reserved_flag = not_reserved_flag and ((reservation.reservation_start < res_start and reservation.reservation_end < res_start) or (reservation.reservation_start > res_end and reservation.reservation_start > res_end))
